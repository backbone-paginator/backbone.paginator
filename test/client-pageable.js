...
QUnit.test("constructor", function (assert) {
  ...
  col = new PageableCollection(mods[0], {
    mode: "client"
  });
  ...
  col = new PageableCollection(mods, {
    comparator: comparator,
    state: {
      pageSize: 2
    },
...
QUnit.test("reset and sort", function (assert) {
  ...
  var mods = models.slice();
  var col = new PageableCollection(mods, {
    state: {
      pageSize: 2
    },
    mode: "client"
...
QUnit.test("getPageByOffset - firstPage is 0", function (assert) {
  ...
  var col = new PageableCollection(manyModels, {
    state: {
      pageSize: 2,
      firstPage: 0,
      currentPage: 0,
...
QUnit.test("setPageSize", function (assert) {
  ...
  col = new PageableCollection(null, {
    state: {
      pageSize: 2
    },
    mode: "client"
  ...
  col = new PageableCollection(models, {
    state: {
      firstPage: 0,
      pageSize: 2
    },
