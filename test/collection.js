(function() {
  ...
  test('get with "undefined" id', function() {
    var collection = new Backbone.PageableCollection([{id: 1}, {id: 'undefined'}]);
  ...
  test("add", 14, function() {
    ...
    var coll = new Backbone.PageableCollection(new Array(2));
    var addCount = 0;
  ...
  test('_addReference binds all collection events & adds to the lookup hashes', 9, function() {
    ...
    var Collection = Backbone.PageableCollection.extend({
      ...
      _addReference: function(model) {
        Backbone.PageableCollection.prototype._addReference.apply(this, arguments);
        calls.add++;
      ...
      _removeReference: function(model) {
        Backbone.PageableCollection.prototype._removeReference.apply(this, arguments);
        calls.remove++;
