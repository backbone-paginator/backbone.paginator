...
Backbone.Paginator = (function ( Backbone, _, $ ) {
    ...
    Paginator.clientPager = Backbone.Collection.extend({
        ...
        initialize: function(){
            ...
            // SET DEFAULT VALUES 
            // This allows user to pass models in directly to a collection without making a .fetch() call 
            this.setDefaults(); 
        },
        
        setDefaults: function() {
            // create top level property names for coveinence. 
            _.defaults(this, this.paginator_ui); 
        }, 
        ...
        sync: function ( method, model, options ) {            
            ...
            // GENERATE URL DATA/PARAMS
            // Some values could be functions
            // Change their scope and execute functions
            var queryData = {};
            
            _.each(this.server_api, function(value, key){
            ...
            // GENERATE AJAX CALL OPTIONS
            // Some values could be functions
            // Change their scope and execute functions
            var queryOptions = _.clone(this.paginator_core);
            ...
            //Set data and url params
            queryOptions.data = decodeURIComponent($.param(queryData)); 
            queryOptions.url = _.result(queryOptions, 'url'); 
       
            //Add custom options
            queryOptions = _.extend(queryOptions, options);
        ...
        nextPage: function () {
            ...
            //Don't call function if on last page
