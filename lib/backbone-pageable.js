  ...
  var PageableCollection = Backbone.Collection.extend({
    ...
    */
    ...
    initialize: function (models, options) {
      ...
      this.switchMode(mode, _.extend({fetch: false, models: models}, options));
    ...
    */
    ...
    switchMode: function (mode, options) {
      ...
      if (mode == "infinite") this.links = {first: this.url};

      if (options.fetch != null && !options.fetch) return this;
    ...
    /**
       ...
       client mode, or does yield a URL under infinite mode.
