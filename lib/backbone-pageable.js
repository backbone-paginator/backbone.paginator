    ...
    _makeCollectionEventHandler: function (pageCol, fullCol) {
      ...
      return function collectionEventHandler (event, model, collection, options) {
        ...
        if (event == "add") {
          ...
          var isClientFetch = pageCol.mode == "client" && options.from == null && options.to == null;
          var isInfiniteGetPage = pageCol.mode == "infinite" && options.from != null && options.to != null;
          if (!options.onRemove && isClientFetch || isInfiniteGetPage) {
            ++state.totalRecords;
