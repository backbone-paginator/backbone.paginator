  ...
  */
  var PageableCollection = Backbone.Collection.extend({
    ...
    */
    ...
    /**
       Overidden to make `getPage` compatible with Zepto due to Backbone [issue
       #1939](https://github.com/documentcloud/backbone/pull/1939).
    ...
    */
    sync: function (method, model, options) {
      ...
      return (BBColProto.sync || Backbone.sync).call(this, method, model, options);
    },
