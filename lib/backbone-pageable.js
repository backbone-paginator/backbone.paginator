    ...
    */
    _checkState: function (state) {
      ...
      if (totalRecords != null && pageSize != null && currentPage != null &&
        ...
        finiteInt(totalRecords, "totalRecords");
        finiteInt(pageSize, "pageSize");
        finiteInt(currentPage, "currentPage");
        finiteInt(firstPage, "firstPage");
    ...
    getPage: function (index, options) {
      ...
      switch (index) {
      case "first": index = firstPage; break;
      case "prev": index = currentPage - 1; break;
      case "next": index = currentPage + 1; break;
      case "last": index = lastPage; break;
      default: finiteInt(index, "index");
      }

      this.state = this._checkState(_.extend({}, state, {currentPage: index}));

      if (this.mode == "client" && !options.fetch) {
        var pageStart = (firstPage === 0 ? index : index - 1) * pageSize;
