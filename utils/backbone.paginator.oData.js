...
(function ( mixins ) {
	...
	mixins.Paginator = {
		...
		/*The idea of the querymap is to provide something which we can map against
		the local queryParams object eg. queryParams.page: queryMap.serverpage, queryParams.perPage: querymap.rpp etc.*/
		queryMap:{
