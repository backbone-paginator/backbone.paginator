  ...
  */
  Backgrid.Extension.Paginator = Backbone.View.extend({
    ...
    /**
       ...
       number of pages to reach from within a window before sliding. For
       example, the default windowSize(10) / slideThreshold(2) yields 5, which
       means the window will slide forward 5 pages as soon as you've reach page
       6. The smaller the number the more pages from within a window one has to
       reach before sliding and vice versa.
    */
    slideThreshold: 2,
